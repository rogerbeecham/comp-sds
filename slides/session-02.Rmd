...
<!-- Preview of session :
Fundamentals of data using bikeshare.
Reason: these fundamentals constrain/inform the type of analysis that we can do.
Describe data -->
...
.tiny-font[
* dataset: Citibike OD trip data
* variable: `trip_count` | `user_age` | `user_sex` | `day_week`
* measurement: `ratio` | `ratio` | `nominal` | `ordinal`
]
