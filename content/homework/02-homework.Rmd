...
Using functions from `dplyr` and `tidyr` reorganise these data so that they are conform to the rules of **tidy** data [@wickham_tidy_2014].
...
* `d_station`: station ide of the destination station
