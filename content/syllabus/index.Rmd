...
A key mechanism through which you can **participate** is by contributing to the discussion forum. Engaging fully with this will help to foster a sort of collegiate atmosphere on the course that will maximise your learning. I have set up a course [Slack](https://comp-sds.slack.com), which should provide a useful mechanism for sharing information, resources and importantly posting and discussing `code`.
