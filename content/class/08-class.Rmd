...
* Download the [<i class="fab fa-r-project"></i> 08-template.Rmd](/homework/08-homework_files/08-template.Rmd) file for this session and save it to the `reports` folder of your `comp-sds` project.
