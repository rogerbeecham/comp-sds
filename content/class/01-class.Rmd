...
Welcome to _Computational Methods for Social Data Science_ (_comp-sds_). In this first session we'll cover the background to the module -- the why, what and how of _comp-sds_. If you've not already you should check out the course outline on the [Syllabus](/syllabus/) page for an overall preview of the module.
