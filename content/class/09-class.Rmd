...
linktitle: "9: Communication and storytelling"
date: "2022-08-18"
class_date: "2022-08-18"
citeproc: true
...
* Download the [<i class="fab fa-r-project"></i> 09-template.Rmd](/homework/09-homework_files/09-template.Rmd) file for this session and save it to the `reports` folder of your `comp-sds` project.
* Open your `comp-sds` project in RStudio and load the template file by clicking `File` > `Open File ...` > `reports/09-template.Rmd`.
