...
Next read this [twitter thread](https://threadreaderapp.com/thread/1138746147269468161.html?refreshed=yes#) demonstrating how these techniques can be depoyed in a data analysis.
...
This class introduces techniques for visually representing networks and evaluates their usefulness through an analysis of 2011 Census OD travel-to-work data.  We will focus on travel-to-work data in London -- the **nodes** in this dataset are London's 33 boroughs and the **edges** are directed OD pairs between these boroughs.
...
# DO map so geometries join on origin (edit this to switch between D-OD and O-DO matrix).
