---
title: "Exploring spatial networks: Containment and connection"
linktitle: "5: Exploring spatial networks"
date: "2021-08-13"
class_date: "2021-08-13"
citeproc: true
...
* Download the [<i class="fab fa-r-project"></i> 05-template.Rmd](/homework/05-homework_files/05-template.Rmd) file for this session and save it to the `reports` folder of your `comp-sds` project.
* Open your `comp-sds` project in RStudio and load the template file by clicking `File` > `Open File ...` > `reports/05-template.Rmd`.
