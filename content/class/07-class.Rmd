---
title: "Model building 2: Expose, estimate, evaluate"
linktitle: "7: Model building 2"
date: "2022-08-16"
class_date: "2022-08-16"
citeproc: true
...
* Download the [<i class="fab fa-r-project"></i> 07-template.Rmd](/homework/07-homework_files/07-template.Rmd) file for this session and save it to the `reports` folder of your `comp-sds` project.
* Open your `comp-sds` project in RStudio and load the template file by clicking `File` > `Open File ...` > `reports/07-template.Rmd`.
