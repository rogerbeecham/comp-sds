...
Welcome to Computational Methods for Social Data Science (comp-sds). For each session you will be working in these `.Rmd` templates, which provide scaffolding for completing the activities that appear in class and for the homework.
